...
documentation for Supabase. If you see something that consistently bothers you, whether
it's an inconsistently used term or an unnecessarily verbose writing pattern, it may
bother others as well. Open a style guide PR and start the discussion.

## Navigation

The files in the style guide are numbered in the order of content size. It starts with the smallest piece,
at the word level, then progresses to the sentence- and structure-level. `WORD_LIST` is unnumbered and a master
document for our word consistency decisions.
...
| [`02-page-structure.md`](./02-page-structure.md) | Document type, section grouping, chunking          |
| [`03-elements.md`](./03-elements.md)             | Admonitions, code blocks, procedures, tabs, images |
