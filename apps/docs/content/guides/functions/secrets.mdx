...
- [Where local values come from](#where-local-values-come-from) explains which file feeds which runtime, and [Default secrets](#default-secrets) lists the variables Supabase injects for you.
