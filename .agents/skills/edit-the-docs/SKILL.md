...
Classify each one against the information types in [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md#information-types), then collapse them into the three buckets you'll group by: **procedural** (Procedure), **contextual** (Concept and Process), and **reference** (Structure and Fact). A principle or a fact usually rides along in the section it qualifies rather than getting one of its own.
...
Order the groups per [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md#grouping-sections), which has the order that works and a worked outline. A short concept opener can precede the procedure group; keep that group uninterrupted, and put the remaining background after it.
