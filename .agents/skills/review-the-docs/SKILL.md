...
- [ ] Section grouping and chunking follow [`02-page-structure.md`](../../../apps/docs/style-guide/02-page-structure.md)
- [ ] Components follow [`03-elements.md`](../../../apps/docs/style-guide/03-elements.md)
